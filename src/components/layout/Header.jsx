  ...
  return (
    <header className="sticky top-0 z-40 bg-white/95 dark:bg-slate-900/95 backdrop-blur-md border-b border-slate-200/80 dark:border-slate-800 shadow-xs transition-colors">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-2.5 sm:py-3.5 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-2 sm:space-x-3.5">
          ...
          >
            ...
            <div className="min-w-0">
              <h1 className="text-xs sm:text-base md:text-lg font-black text-blue-950 dark:text-white tracking-tight leading-tight">
                {schoolName}
              </h1>
              <p className="text-[10px] sm:text-xs font-semibold text-slate-500 dark:text-slate-400 tracking-wider flex items-center gap-1 sm:gap-1.5">
                <span className="hidden sm:inline">{tagline}</span>
                <span className="hidden sm:inline w-1.5 h-1.5 rounded-full bg-blue-600"></span>
        ...
        {/* Right Actions: Theme Toggle, Search & APPLY NOW (Mobile Optimized) */}
        <div className="flex items-center space-x-1 sm:space-x-2.5 flex-shrink-0">
          ...
          <button
            ...
            className="w-8 h-8 sm:w-10 sm:h-10 flex items-center justify-center rounded-full text-slate-700 dark:text-amber-400 hover:bg-slate-100 dark:hover:bg-slate-800 transition cursor-pointer shadow-2xs"
            title={darkMode ? "Switch to Light Mode" : "Switch to Dark Mode"}
          >
            {darkMode ? (
              <Sun className="w-4 h-4 sm:w-5 sm:h-5 transition-transform hover:rotate-90 duration-300" />
            ) : (
              <Moon className="w-4 h-4 sm:w-5 sm:h-5 transition-transform hover:-rotate-12 duration-300" />
            )}
          </button>
          ...
          <button
            ...
            className="w-8 h-8 sm:w-10 sm:h-10 flex items-center justify-center rounded-full text-slate-700 dark:text-slate-200 hover:text-blue-600 hover:bg-slate-100 dark:hover:bg-slate-800 transition cursor-pointer"
          >
            <Search className="w-4 h-4 sm:w-5 sm:h-5" />
          </button>

          {/* MAIN PAGE APPLY BUTTON */}
          <button
            onClick={onOpenAdmission}
            className="px-2.5 sm:px-5 py-1.5 sm:py-2.5 rounded-full bg-blue-600 hover:bg-blue-700 active:scale-95 text-white text-[11px] sm:text-sm font-bold shadow-md shadow-blue-600/20 transition cursor-pointer flex items-center space-x-1 sm:space-x-1.5 flex-shrink-0"
          >
